...
const Index = () => {
  ...
  return <div className="min-h-screen flex flex-col">
    ...
    }} className="bg-gradient-to-br from-gray-900 to-black text-white py-20 px-6 flex-grow flex flex-col justify-center items-center text-center bg-transparent">
